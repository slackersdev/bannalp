        ...
        <div className="max-w-7xl mx-auto px-6 md:px-16 lg:px-24">
          <div className="grid lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                  {lifts.map((lift, index) => (
                    <motion.div
                      ...
                      onMouseEnter={() => setHoveredLift(lift.id)}
                      onMouseLeave={() => setHoveredLift(null)}
                      className={`flex items-center justify-between p-4 rounded-md border border-gray-200 hover:border-gray-400 hover:shadow-md transition-all cursor-pointer ${hoveredLift === lift.id ? 'border-gray-400 shadow-md bg-gray-50' : ''
                        }`}
                    >
                      <div className="flex items-center gap-4">
                        <div className={`flex items-center justify-center w-10 h-10 rounded-md text-white ${lift.status === 'open' ? 'bg-green-700' : 'bg-red-900'
                          }`}>
                          {lift.id}
                        </div>
            ...
            <div className="bg-black text-white rounded-md shadow-lg p-8">
              <h4 className="mb-4 border-b border-gray-700 pb-3 uppercase tracking-wider">
                Betriebszeiten
              </h4>
              <div className="space-y-2">
