...
export default function LiftStatusSection() {
  ...
  return (
    <section id="lifts" className="py-20 bg-gray-50">
        ...
        <div className="relative w-full h-[600px] md:h-[700px] lg:h-[800px]">
          ...
          <div className="absolute top-6 left-6 flex flex-col gap-2 z-20">
            ...
            <button
              ...
              className={`w-12 h-12 rounded-md flex items-center justify-center transition-all shadow-lg ${activeFilters.length > 0
            ...
            <button
              ...
              className={`w-12 h-12 rounded-md flex items-center justify-center transition-all shadow-lg ${season === 'summer'
            ...
            <button
              ...
              className={`w-12 h-12 rounded-md flex items-center justify-center transition-all shadow-lg ${season === 'winter'
            ...
            <button
              ...
              className={`w-12 h-12 rounded-md flex items-center justify-center transition-all shadow-lg ${activeFilters.includes('lifts')
                ? 'bg-blue-600 text-white'
                : 'bg-white/90 text-gray-700 hover:bg-white'
                }`}
            ...
            <button
              ...
              className={`w-12 h-12 rounded-md flex items-center justify-center transition-all shadow-lg ${activeFilters.includes('hiking')
            ...
            <button
              ...
              className={`w-12 h-12 rounded-md flex items-center justify-center transition-all shadow-lg ${activeFilters.includes('restaurants')
            ...
            <button
              ...
              className={`w-12 h-12 rounded-md flex items-center justify-center transition-all shadow-lg ${activeFilters.includes('biking')
            ...
            <button
              ...
              className={`w-12 h-12 rounded-md flex items-center justify-center transition-all shadow-lg ${activeFilters.includes('viewpoints')
            ...
            <button
              ...
              className={`w-12 h-12 rounded-md flex items-center justify-center transition-all shadow-lg ${activeFilters.includes('more')
              ...
              {lift.stations.map((station, idx) => (
                ...
                >
                  <div className="relative group cursor-pointer">
                    {/* Marker dot */}
                    <div className={`${station.isMid ? 'w-3 h-3 border-2' : 'w-6 h-6 border-4'} rounded-full border-white shadow-lg transition-all ${lift.status === 'open'
                      ? 'bg-green-700'
                      : 'bg-red-900'
                    ...
                    {idx === 0 && (
                      <div className="absolute left-1/2 -translate-x-1/2 -top-24 bg-black text-white px-5 py-3 rounded-md opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none z-10 shadow-lg">
                        <div className="flex items-center gap-3 mb-2">
                          <div className={`flex items-center justify-center w-8 h-8 rounded-md text-white ${lift.status === 'open' ? 'bg-green-700' : 'bg-red-900'
                            }`}>
                            {lift.id}
                          </div>
                          <Circle
                            className={`${lift.status === 'open'
          ...
          {season === 'winter' && (
            <div className="absolute bottom-6 right-6 bg-white rounded-md shadow-lg p-4">
              <h4 className="mb-3 uppercase tracking-wider" style={{ fontSize: '12px' }}>Legende</h4>
                  ...
                  {route.stations.map((station, idx) => (
                    ...
                    >
                      <div className="relative group cursor-pointer">
                        {/* Marker dot */}
                        <div
                          className={`${station.isMid ? 'w-3 h-3 border-2' : 'w-6 h-6 border-4'} rounded-full border-white shadow-lg transition-all ${hoveredLift === route.id ? 'ring-4 ring-black/20' : ''
                            }`}
      ...
      {season === 'winter' && (
        <div className="max-w-7xl mx-auto px-6 md:px-16 lg:px-24">
          <h3 className="mb-8 text-center border-b-2 border-gray-300 pb-4 uppercase tracking-wider" style={{ fontSize: 'clamp(1.5rem, 3vw, 2.5rem)' }}>
            Live Status
          </h3>

          <div className="grid lg:grid-cols-2 gap-8">
            {/* Left Container - General/Year-Round Facilities */}
            <div>
              <div className="bg-white rounded-md shadow-lg p-8">
                <h4 className="mb-6 border-b border-gray-200 pb-3 uppercase tracking-wider">
                  Ganzjährig
                </h4>
                ...
                <div className="space-y-6">
                  {/* Luftseilbahn */}
                  <div>
                    <h5 className="mb-3 font-semibold uppercase tracking-wide" style={{ fontSize: '12px' }}>Luftseilbahn</h5>
                    <div className="space-y-2 ml-4">
                      {yearRoundFacilities.luftseilbahn.map((facility, idx) => (
                        <div key={idx} className="flex items-center gap-2 text-sm">
                          <Circle
                            className={`flex-shrink-0 ${facility.status === 'open'
                              ? 'fill-green-700 text-green-700'
                              : 'fill-red-900 text-red-900'
                              }`}
                            size={10}
                  ...
                  {/* Wanderweg */}
                  <div>
                    <h5 className="mb-3 font-semibold uppercase tracking-wide" style={{ fontSize: '12px' }}>Wanderweg</h5>
                    <div className="space-y-2 ml-4">
                      {yearRoundFacilities.wanderweg.map((facility, idx) => (
                        <div key={idx} className="flex items-center gap-2 text-sm">
                          <Circle
                            className={`flex-shrink-0 ${facility.status === 'open'
                              ? 'fill-green-700 text-green-700'
                  ...
                  {/* Alpwirtschaft */}
                  <div>
                    <h5 className="mb-3 font-semibold uppercase tracking-wide" style={{ fontSize: '12px' }}>Alpwirtschaft</h5>
                    <div className="space-y-2 ml-4">
                      {yearRoundFacilities.alpwirtschaft.map((facility, idx) => (
                        <div key={idx} className="flex items-center gap-2 text-sm">
                          <Circle
                            className={`flex-shrink-0 ${facility.status === 'open'
                              ? 'fill-green-700 text-green-700'
                  ...
                  {/* Berggasthaus */}
                  <div>
                    <h5 className="mb-3 font-semibold uppercase tracking-wide" style={{ fontSize: '12px' }}>Berggasthaus</h5>
                    <div className="space-y-2 ml-4">
                      {yearRoundFacilities.berggasthaus.map((facility, idx) => (
                        <div key={idx} className="flex items-center gap-2 text-sm">
                          <Circle
                            className={`flex-shrink-0 ${facility.status === 'open'
                              ? 'fill-green-700 text-green-700'
            ...
            {/* Right Container - Winter-Specific Facilities */}
            <div className="bg-black text-white rounded-md shadow-lg p-8">
              <h4 className="mb-6 border-b border-gray-700 pb-3 uppercase tracking-wider">
                Winter
              </h4>
              ...
              <div className="space-y-6">
                {/* Skilift */}
                <div>
                  <h5 className="mb-3 font-semibold uppercase tracking-wide" style={{ fontSize: '12px' }}>Skilift</h5>
                  <div className="space-y-2 ml-4">
                    {winterFacilities.skilift.map((facility, idx) => (
                      <div key={idx} className="flex items-center gap-2 text-sm">
                        <Circle
                          className={`flex-shrink-0 ${facility.status === 'open'
                            ? 'fill-green-700 text-green-700'
                ...
                {/* Schneeschuhpfad */}
                <div>
                  <h5 className="mb-3 font-semibold uppercase tracking-wide" style={{ fontSize: '12px' }}>Schneeschuhpfad</h5>
                  <div className="space-y-2 ml-4">
                    {winterFacilities.schneeschuhpfad.map((facility, idx) => (
                      <div key={idx} className="flex items-center gap-2 text-sm">
                        <Circle
                          className={`flex-shrink-0 ${facility.status === 'open'
                            ? 'fill-green-700 text-green-700'
                ...
                {/* Schneebar */}
                <div>
                  <h5 className="mb-3 font-semibold uppercase tracking-wide" style={{ fontSize: '12px' }}>Schneebar</h5>
                  <div className="space-y-2 ml-4">
                    {winterFacilities.schneebar.map((facility, idx) => (
                      <div key={idx} className="flex items-center gap-2 text-sm">
                        <Circle
                          className={`flex-shrink-0 ${facility.status === 'open'
                            ? 'fill-green-700 text-green-700'
          ...
          {/* Operating Hours - Full Width Container Below */}
          <div className="mt-8 bg-white rounded-md shadow-lg p-8">
            <h4 className="mb-4 border-b border-gray-200 pb-3 uppercase tracking-wider">
              Betriebszeiten
            </h4>
